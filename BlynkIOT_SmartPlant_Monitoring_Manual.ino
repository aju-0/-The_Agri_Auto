...
#include <DHT.h>
#define BLYNK_TEMPLATE_ID "TMPLGm4_Qhrt"
#define BLYNK_TEMPLATE_NAME "AGRI PRJOECT"
#define BLYNK_AUTH_TOKEN "uSU-dlHJMs_8J9quJFDRLVFYw_-weEh5"

//Initialize the LCD display
LiquidCrystal_I2C lcd(0x27, 16, 2);


char auth[] = "uSU-dlHJMs_8J9quJFDRLVFYw_-weEh5";  //Enter your Blynk Auth token
char ssid[] = "1234";  //Enter your WIFI SSID
